...
<img src="https://skillicons.dev/icons?i=html,css,js,java,react,nodejs,php,ts,nextjs,dart,flutter,c,angular,laravel,swift,ts,vite,cs,dotnet,py,pycharm,aws,tensorflow,ubuntu,gcp,azure,mongodb,git,github,githubactions,express,tailwind,threejs,bootstrap,git,vercel,kubernetes,docker,mysql,firebase,postman,linux,idea,eclipse,stackoverflow,terraform,androidstudio,apple,devto,vscode,django,sqlite,visualstudio,redhat,figma,discord,bash&theme=dark&perline=15"/>
 </a>
</p>
